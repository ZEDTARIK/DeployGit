    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let object of objects) {
                ...
                trHTML += '<td><button style="margin-right: 8px;" type="button" class="btn btn-sm btn-outline-warning" onclick="showUserEditBox(' + object['id'] + ')">Edit</button>';
                trHTML += '<button type="button" class="btn btn-sm btn-outline-danger" onclick="userDelete(' + object['id'] + ')">Del</button></td>';
                trHTML += "</tr>";
            }
